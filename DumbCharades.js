const movies = [
    ...
    },
    {
      ...
      hints: [
        ...
        "There'  a lot of fire in this movie, literally and figuratively.",
    ...
    },
    {
      ...
      hints: [
        ...
        "Iss not just a game, it's a matter of survival.",
    ...
    },
    {
      ...
      hints: [
        ...
        "The movies title is related to their first meeting.",
...
let srtBtn = document.getElementById('start');
let enterBtn = document.getElementById('enter');
let guessBtn = document.getElementById('guessBtn');
let restartBtn = document.getElementById('resBtn');
...
function startNewGame() {
    ...
    hint.textContent = Movie.hints[hintidx];
    message.textContent = '';
    guess.value = '';
...
guessBtn.addEventListener('click', () => {
    ...
    if (userGuess === Movie.title.toLowerCase()) {
        message.textContent = `CONGRATULATIONS ${playerName}! YOU GUESSED THE MOVIE 🎉🎊 YOUR SCORE IS ${score}`;
        guess.disabled = true;
        ...
        if (score > 0) {
            hintidx++;
            if (hintidx < Movie.hints.length) {
                hint.textContent = Movie.hints[hintidx];
                message.textContent = "KEEP TRYING 🥷🏻";
            } else {
                message.textContent = `NO MORE HINTS! Your score is ${score}.`;
            }
        } else {
            message.textContent = `YOU WERE NOT ABLE TO GUESS THE MOVIE. THE MOVIE WAS "${Movie.title}".`;
            guess.disabled = true;
            guessBtn.disabled = true;
            restartBtn.style.display = 'block';
        }
